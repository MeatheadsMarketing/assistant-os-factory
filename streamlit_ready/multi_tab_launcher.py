# multi_tab_launcher.py
"""Fixed launcher for Streamlit Cloud: safe path + f-string"""

import streamlit as st
import importlib.util
import os

st.set_page_config(page_title="Multi-Tab Launcher", layout="wide")
...
if tabs:
    ...
    # GPT Suggestion Area (fixed f-string)
